...
test("bedStatus: 各分岐の説明文を固定する", () => {
  ...
  assert.equal(
    ...
    "2024年に同じ科の作付けがあります。間隔は2年で、トマトの目安4年に足りません。いまある記録のままだと、どの作付けからも4年あくのは早くて2030年です。",
  );
  ...
  assert.equal(
    ...
    "2024年に同じ科の作付けがあります。間隔は2年で、トマトの目安4年に足りません。どちらも過ぎた年のことなので、これから植えるものは下の「いま植えるなら」で確かめてください。",
  );
